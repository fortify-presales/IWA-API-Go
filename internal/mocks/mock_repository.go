...
// Source: github.com/fortify-presales/insecure-go-api/internal/models (interfaces: Repository)
...
func (m *MockRepository) Populate() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Populate")
}

// Populate indicates an expected call of Populate.
func (mr *MockRepositoryMockRecorder) Populate() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Populate", reflect.TypeOf((*MockRepository)(nil).Populate))
}
